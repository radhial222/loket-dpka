...
#DEFINE MB_YA                   1       && OK button only
#DEFINE MB_YABATAL              2       && OK and Cancel buttons
#DEFINE MB_YATIDAKBATAL         3       && Yes, No, and Cancel buttons
#DEFINE MB_YATIDAK              4       && Yes and No buttons
#DEFINE MB_COBABATAL            5       && Retry and Cancel buttons

#DEFINE MB_ICONHENTI            1       && Critical message
#DEFINE MB_ICONTANYA            2       && Warning query
#DEFINE MB_ICONSERU             3       && Warning message
#DEFINE MB_ICONINFORMASI        4       && Information message

*-- MsgBox return values
#DEFINE IDYA            1       && OK button pressed
#DEFINE IDTIDAK         2       && No button pressed
#DEFINE IDBATAL         3       && Cancel button pressed
